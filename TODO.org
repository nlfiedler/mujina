...
- [TODO] Use React to build the drop zone
  ...
  - [TODO] Clicking on upload icon should open file selector
    - Or use "tag" property to change the default HTML element to a non-A tag
  - [TODO] Replace the placeholder image with Content with a background color
