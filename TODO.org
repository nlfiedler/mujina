...
- [TODO] Figure out how to use Redux for modeling the app state
  ...
  - [TODO] Consider https://github.com/pburtchaell/redux-promise-middleware
    - converts a "FOO" promise action into "FULFILLED" and "REJECTED" actions
  - [TODO] See "runSaga" in redux-saga API reference for code organization and startup
  - [DONE] Set up a mock backend for testing
  - [DONE] Use https://redux-saga.js.org for data fetching
  - [TODO] Look at using immutable.js for the redux state
    - https://github.com/AnatoliyGatt/deep-freeze-node
  ...
  - [TODO] Look at https://github.com/evgenyrodionov/redux-logger for logging state changes for debugging and support
