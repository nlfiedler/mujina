...
- [TODO] Change the asset filters to use the same tag styles as the web ui
- [TODO] Years probably should be listed in descending order
- [TODO] Years should only allow one selection at a time
...
- [TODO] Upon first time startup, configure the backend and start it
- [TODO] On macOS, store everything under "~/Pictures/Tanuki Photos"
