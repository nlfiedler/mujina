...
**** DONE Test it on a Windows VM /before/ updating
**** TODO Also update electron-store, which now requires Electron 2.0
**** DONE Test on a Windows VM to make sure it still works
*** Rewrite interface using [[https://tailwindcss.com/docs/what-is-tailwind/][Tailwind CSS]]
