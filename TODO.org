...
**** DONE Replace ThumbnailRow with ThumbnailColumn that is just like filters
...
*** Quick Ones
**** DONE Use =.npmrc= to avoid creating =package-lock.json= file
*** Glitches
...
**** DONE Make the asset sidebar sticky so it does not scroll away
**** DONE Make the asset selector (thumbnail row) sticky so it does not scroll away
*** Bulk Edit
